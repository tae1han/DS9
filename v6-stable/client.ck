...
modalBarInst instParrot(6); instParrot.gain(2.5);
ezFluidInst instParakeet("./data/TimGM6mb.sf2", 24); instParakeet.gain(8);
krstlchrInst instAlbatross; instAlbatross.gain(0.8);
frenchrnInst instPeacock; instPeacock.gain(1.1);
synthBassInst instEmu; instEmu.gain(.9);
arpInst instFalcon; instFalcon.gain(.5);
